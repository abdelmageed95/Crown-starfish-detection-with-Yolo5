...
def detect():
    ...
    with open(os.path.join(r"C:\Users\alaa\Desktop\Crown-starfish-detection",path_original), "rb") as f:
        image_binary = f.read()
    image_original = b64encode(image_binary).decode("utf-8")
    with open(os.path.join(r"C:\Users\alaa\Desktop\Crown-starfish-detection",path_preprocessing), "rb") as f:
        image_binary = f.read()
    image_preprocessing = b64encode(image_binary).decode("utf-8")
    with open(os.path.join(r"C:\Users\alaa\Desktop\Crown-starfish-detection",path_augemented), "rb") as f:
        image_binary = f.read()
